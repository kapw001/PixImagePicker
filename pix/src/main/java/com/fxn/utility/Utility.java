...
public class Utility {
  ...
  public static void getScreenSize(AppCompatActivity activity) {
  ...
  public static File writeImage(File photo, Bitmap bitmap, String path, int quality, int newWidth,
      int newHeight) {
    Log.e("click ", "time 5");
  ...
  public static Bitmap getScaledBitmap(float maxWidth, Bitmap rotatedBitmap) {
    try {

      int nh = (int) (rotatedBitmap.getHeight() * (maxWidth / rotatedBitmap.getWidth()));
      return Bitmap.createScaledBitmap(rotatedBitmap, (int) maxWidth, nh, true);
    } catch (Exception e) {
      e.printStackTrace();
      return null;
    }
  ...
  public static Bitmap getRotatedBitmap(Context context, String path) {
    try {
      Bitmap img = new BitmapDrawable(context.getResources(), path).getBitmap();
      ExifInterface ei = new ExifInterface(path);
      int orientation =
          ei.getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface.ORIENTATION_UNDEFINED);
      Log.e("orientaion", "-> " + orientation);
